...
EditCustomerProfileModel editCustomerProfileModelFromJson(String str) => EditCustomerProfileModel.fromJson(json.decode(str));
String editCustomerProfileModelToJson(EditCustomerProfileModel data) => json.encode(data.toJson());

class EditCustomerProfileModel {
  EditCustomerProfileModel({
    bool? status,
    String? message,
    Customer? customer,
  }) {
  ...
  EditCustomerProfileModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  Customer? _customer;
  EditCustomerProfileModel copyWith({
    bool? status,
    String? message,
    Customer? customer,
  }) =>
