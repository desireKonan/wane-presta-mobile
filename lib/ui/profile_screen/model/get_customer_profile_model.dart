import 'dart:convert';
GetCustomerProfileModel getCustomerProfileModelFromJson(String str) => GetCustomerProfileModel.fromJson(json.decode(str));
String getCustomerProfileModelToJson(GetCustomerProfileModel data) => json.encode(data.toJson());
class GetCustomerProfileModel {
  ...
  GetCustomerProfileModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  Customer? _customer;
GetCustomerProfileModel copyWith({  bool? status,
  String? message,
  Customer? customer,
}) => GetCustomerProfileModel(  status: status ?? _status,
