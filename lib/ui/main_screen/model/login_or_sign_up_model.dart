...
LoginOrSignUpModel loginOrSignUpModelFromJson(String str) => LoginOrSignUpModel.fromJson(json.decode(str));
String loginOrSignUpModelToJson(LoginOrSignUpModel data) => json.encode(data.toJson());
...
class LoginOrSignUpModel {
  ...
  LoginOrSignUpModel.fromJson(dynamic json) {
    _status = json['status'];
