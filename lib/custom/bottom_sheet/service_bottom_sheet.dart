...
class ServiceBottomSheet extends StatelessWidget {
  final List<GetProviderServiceData> services;
  final int index;
                        ...
                        child: FadeInAnimation(
                          child: GestureDetector(
                            onTap: () {
                              ...
                              logic.serviceId = services[serviceIndex].serviceId?.id ?? "";
                              logic.servicePrice = services[serviceIndex].price.toString();
                              logic.serviceName = services[serviceIndex].serviceId?.name ?? "";
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: "${ApiConstant.BASE_URL}${services[serviceIndex].serviceId?.image ?? ""}",
                                  ...
                                  Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Text(
                                          services[serviceIndex].serviceId?.name ?? "",
